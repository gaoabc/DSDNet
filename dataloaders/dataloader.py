...
class FundusSegmentation(Dataset):
    ...
    def __init__(self,
                 base_dir='/mnt/data2/home/gaogeng/MiDSS-master/data/Fundus/',
                 phase='train',
                 splitid=2,
                 domain=[1,2,3,4],
                 weak_transform=None,
        ...
        for i in self.domain:
            self._image_dir = os.path.join(self._base_dir, 'Domain'+str(i), phase, 'image/')
            print('==> Loading {} data from: {}'.format(phase, self._image_dir))

            imagelist = glob(os.path.join(self._image_dir + '*.png'))
...
class EECSegmentation(Dataset):
    ...
    def __init__(self,
                 base_dir='/mnt/data2/home/gaogeng/MiDSS-master/data/EEC/',
                 phase='train',
                 splitid=2,
                 domain=[1, 2, 3, 4],
                 weak_transform=None,
        ...
        print(
            '-----Total number of images in {}: {:d}, Excluded: {:d}'.format(phase, len(self.image_pool), excluded_num))
    ...
    def __getitem__(self, index):
        if self.phase != 'test':
            ...
            if _target.mode == 'RGB':
                _target = _target.convert('L')
            _target = _target.resize((256, 256), Image.NEAREST)
            anco_sample = {'image': _img, 'label': _target, 'img_name': self.img_name_pool[index],
    ...
    def __str__(self):
        return 'EEC(phase=' + self.phase + str(self.splitid) + ')'
class EGCSegmentation(Dataset):
    """
    Fundus segmentation dataset
    including 5 domain dataset
    one for test others for training
    ...
    def __init__(self,
                 base_dir='/mnt/data2/home/gaogeng/MiDSS-master/data/EGC/',
                 phase='train',
                 splitid=2,
                 domain=[1, 2, 3, 4],
                 weak_transform=None,
    ...
    def __str__(self):
        return 'EEC(phase=' + self.phase + str(self.splitid) + ')'
class PolypSegmentation(Dataset):
    """
    Fundus segmentation dataset
    including 5 domain dataset
    one for test others for training
    ...
    def __init__(self,
                 base_dir='/mnt/data2/home/gaogeng/MiDSS-master/data/Polyp/',
                 phase='train',
                 splitid=2,
                 domain=[1, 2, 3, 4],
                 weak_transform=None,
...
class ISIC2018Segmentation(Dataset):
    ...
    def __init__(self,
                 base_dir='/mnt/data2/home/gaogeng/MiDSS-master/data/ISIC2018/',
                 phase='train',
                 splitid=2,
                 domain=[1, 2, 3, 4],
                 weak_transform=None,
...
class CVC_ClinicDBSegmentation(Dataset):
    """
    Fundus segmentation dataset
    including 5 domain dataset
    one for test others for training
    ...
    def __init__(self,
                 base_dir='/mnt/data2/home/gaogeng/MiDSS-master/data/CVC-ClinicDB/',
                 phase='train',
                 splitid=2,
                 domain=[1, 2, 3, 4],
                 weak_transform=None,
...
if __name__ == '__main__':
    ...
    voc_train = FundusSegmentation(splitid=[1,2],domain=[2],)
